...
import com.android.db.multirecycleviewadapter.adapter.ItemClickAdapter
import com.android.db.multirecycleviewadapter.animation.ScaleInAnimation
...
class ItemClickActivity : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        adapter!!.onItemLongClickListener = object : BaseAdapter.OnItemLongClickListener {
        ...
        adapter!!.onItemChildClickListener = object : BaseAdapter.OnItemChildClickListener {
        ...
        adapter!!.onItemChildLongClickListener = object : BaseAdapter.OnItemChildLongClickListener {
    ...
    private fun initAdapter() {
        ...
        adapter!!.animation = ScaleInAnimation()
